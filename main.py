...
INSTRUCTION_LINKS = {
    ...
    "mac": "https://apps.apple.com/app/outline-app/id1356177741",  # Use iOS link for Mac
    "linux": "https://s3.amazonaws.com/outline-releases/client/linux/stable/Outline-Client.AppImage",
}
INSTRUCTION_TEXTS = {
    "mac": (
        "Инструкция для MacOS:\n\n"
        "1️⃣ Нажми на ключ доступа (находится в /my_subscriptions, начинается с ss://)\n"
        "2️⃣ Скачай и установи приложение: {link}\n"
    ...
    "ios": (
        "Инструкция для iOS:\n\n"
        "1️⃣ Скопируй ключ доступа (находится в /my_subscriptions, начинается с ss://)\n"
        "2️⃣ Скачай и установи приложение: {link}\n"
