#!/usr/bin/env python3
"""
Simple Fixed Enhanced VLESS-only Telegram Bot for VPS deployment
...
async def vless_subscribe(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        ...
        if user_uuid and vless_uri:
            ...
            # Send response to user without Markdown formatting
...
def main() -> None:
    ...
    # Start the bot
    logger.info(f"Starting Simple Fixed Enhanced VLESS-only bot with {MANAGEMENT_MODE} management mode...")
